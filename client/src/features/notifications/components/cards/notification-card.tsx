...
export function NotificationCard({
    ...
    return (
        <div
            className={`group flex items-start gap-4 p-4 rounded-xl transition-colors cursor-pointer border ${
                isSelected
                    ? 'bg-primary-50/50 border-primary-200'
                    : 'bg-white border-transparent hover:bg-default-50 hover:border-default-200'
            }`}
            onClick={onToggle}
        >
            {/* Checkbox */}
