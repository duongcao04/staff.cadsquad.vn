...
import { MotionAside, MotionButton, MotionDiv, MotionP } from '@/presentation/lib/motion'
import {
    ActionButton,
    IconCalendarOutline,
    IconCollapse,
...
import {
    IconOnboard,
    IconOnboardOutline,
} from '@presentation/components/icons/sidebar-icons/IconOnboard'
import {
    IconWorkbench,
    IconWorkbenchOutline,
} from '@presentation/components/icons/sidebar-icons/IconWorkbench'
import { appStore, ESidebarStatus, toggleSidebar } from '@/presentation/stores'
