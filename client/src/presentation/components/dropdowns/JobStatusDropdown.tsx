...
import { updateJobStatusOptions, useProfile } from '@/presentation/lib/queries'
import {
    jobStatusesListOptions,
    statusByOrderOptions,
} from '@/presentation/lib/queries/options/job-status-queries'
import { darkenHexColor, JOB_STATUS_CODES, lightenHexColor } from '@/presentation/lib/utils'
import type { TJob, TJobStatus } from '@/presentation/types'
