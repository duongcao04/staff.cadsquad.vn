import { JobActivityHistory } from '@/presentation/features/job-details'
import { optimizeCloudinary } from '@/presentation/lib'
import { HeroTooltip } from '@presentation/components'
import { TJobActivityLog, TUser } from '@/presentation/types'
