import { sharepointApi, sharepointFolderItemsOptions } from '@/presentation/lib'
import { deliverJobOptions, jobsPendingDeliverOptions } from '@/presentation/lib/queries'
import {
    DeliverJobInputSchema,
    TDeliverJobInput,
} from '@/presentation/lib/validationSchemas/_job.schema'
import { HeroAutocomplete, HeroAutocompleteItem } from '@presentation/components'
