import { cn, INTERNAL_URLS, useMarkAllSeenMutation } from '@/presentation/lib'
import { CHANNELS } from '@/presentation/lib/ably'
import { jobsListOptions, useProfile } from '@/presentation/lib/queries'
import { workbenchDataOptions } from '@/presentation/lib/queries/options/job-queries'
import { notificationsListOptions } from '@/presentation/lib/queries/options/notification-queries'
import { queryClient } from '@/main'
import { BellIcon } from '@presentation/components/icons/animate/BellIcon'
import { HeroButton } from '@presentation/components/ui/hero-button'
import { NotificationStatusEnum, NotificationTypeEnum } from '@/presentation/enums'
import { TUserNotification } from '@/presentation/types'
import {
    addToast,
    Badge,
    Button,
