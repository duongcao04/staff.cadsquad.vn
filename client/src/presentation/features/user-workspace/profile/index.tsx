import { ProfileMobileContent } from '@/presentation/features/profile'
import JobCard from '@/presentation/features/profile/components/JobCard'
import { useDevice } from '@/presentation/hooks'
import { jobsListOptions, useProfile } from '@/presentation/lib/queries'
import { INTERNAL_URLS, JOB_STATUS_CODES } from '@/presentation/lib/utils'
import {
    Button,
    Card,
    CardBody,
