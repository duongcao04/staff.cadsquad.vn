import { pCenterTableStore } from '@/presentation/features/project-center'
import {
    bulkUpdateJobStatusOptions,
    jobStatusesListOptions,
} from '@/presentation/lib/queries'
import { HeroSelect, HeroSelectItem } from '@presentation/components'
import {
    Button,
    Modal,
    ModalBody,
...
export default function BulkChangeStatusModal({
    ...
    const { mutateAsync: bulkChangeStatusMutate, isPending: isUpdating } =
        useMutation(bulkUpdateJobStatusOptions)
