import { pCenterTableStore, toggleJobColumns } from '@/presentation/features/project-center'
import { useProfile } from '@/presentation/lib'
import { getAllowedJobColumns } from '@/presentation/lib/utils'
import { ColumnMeta, ViewColumnsDrawer } from '@presentation/components'
import type { JobColumnKey } from '@/presentation/types'
