import { DeliverJobModal } from '@/presentation/features/job-manage/components/modals/DeliverJobModal'
import ReScheduleModal from '@/presentation/features/job-manage/components/modals/ReScheduleModal'
import AssignMemberModal from '@/presentation/features/user-workspace/project-center/_components/modals/AssignMemberModal'
import UpdateCostModal from '@/presentation/features/user-workspace/project-center/_components/modals/UpdateCostModal'
import { INTERNAL_URLS, JobHelper } from '@/presentation/lib'
import {
    cancelJobOptions,
    markJobPaidOptions,
    workbenchDataOptions,
} from '@/presentation/lib/queries'
import { APP_PERMISSIONS } from '@/presentation/lib/utils'
import ConfirmModal from '@presentation/components/ui/confirm-modal'
...
import {
    ...
    HeroModalFooter,
    HeroModalHeader,
} from '@presentation/components/ui/hero-modal'
import {
    CircleCheck,
    Clock,
    LocationArrow,
