import { IMAGES, optimizeCloudinary } from '@/presentation/lib'
import { userOptions } from '@/presentation/lib/queries/options/user-queries'
import {
    Avatar,
    Card,
    CardBody,
...
import type { TJobActivityLog } from '@/presentation/types'
