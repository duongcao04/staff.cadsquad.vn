import { DeliverJobModal } from '@/presentation/features/job-manage'
import { APP_PERMISSIONS, jobByNoOptions, jobStatusesListOptions } from '@/presentation/lib'
import { JobFinishChip } from '@presentation/components'
import { JobStatusSystemTypeEnum } from '@/presentation/enums'
import { PermissionGuard } from '@/presentation/guards/permission'
