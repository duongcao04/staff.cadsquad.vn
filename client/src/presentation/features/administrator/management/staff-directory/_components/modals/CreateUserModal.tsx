import { generatePassword } from '@/presentation/lib'
import {
    createUserOptions,
...
import { transformEmail } from '@/presentation/lib/utils'
import { ScrollArea, ScrollBar } from '@presentation/components'
import { HeroCopyButton } from '@presentation/components/ui/hero-copy-button'
import { HeroInput } from '@presentation/components/ui/hero-input'
import { HeroModal, HeroModalContent } from '@presentation/components/ui/hero-modal'
import { HeroPasswordInput } from '@presentation/components/ui/hero-password-input'
import { HeroSelect, HeroSelectItem } from '@presentation/components/ui/hero-select'
import { useDevice } from '@/presentation/hooks'
import { TDepartment, TJobTitle, TRole } from '@/presentation/types'
import {
    addToast,
    Button,
    Checkbox,
