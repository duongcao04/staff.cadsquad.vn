...
import { DepartmentChip } from '@presentation/components'
import { RoleChip } from '@presentation/components/chips/RoleChip'
import {
    HeroCard,
    HeroCardBody,
    HeroCardFooter,
    HeroCardHeader,
} from '@presentation/components/ui/hero-card'
import { IPaginate } from '@/presentation/interfaces'
