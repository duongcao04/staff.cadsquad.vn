...
import { AdminPageHeading, CancelModal } from '@presentation/components'
...
export function FolderTemplateDetailPage() {
    ...
    const { id } = useParams({
        from: '/_administrator/mgmt/jobs/folder-templates/$id',
    })
            ...
            <CancelModal
                ...
                message={
                    <span>
                        ...
                        <br /> This action cannot be undone, and the template
                        will no longer be available for new jobs.
                    </span>
                }
