import { INTERNAL_URLS } from '@/presentation/lib'
...
import { Activity, ChevronLeft, MoreVertical, Users } from 'lucide-react'

export function JobTitleDetailPage() {
    const { code } = useParams({
        from: '/_administrator/mgmt/job-titles/$code',
    })
    const {
        data: { jobTitle },
