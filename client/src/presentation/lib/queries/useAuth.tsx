import { authApi } from '@/presentation/lib/api'
import { cookie } from '@/presentation/lib/cookie'
import { COOKIES } from '@/presentation/lib/utils'
import {
    UserSchema,
    type TLoginInput,
    type TUpdateProfileInput,
} from '@/presentation/lib/validationSchemas'
import type { TUser } from '@/presentation/types'
