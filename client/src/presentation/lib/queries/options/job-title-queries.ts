import { jobTitleApi } from '@/presentation/lib/api'
import { JobTitleSchema, TCreateJobTitleInput, TUpdateJobTitleInput } from '@/presentation/lib/validationSchemas'
import { parseData, parseList } from '@/presentation/lib/zod'
