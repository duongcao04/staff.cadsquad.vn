import { AddRoleMemberModal } from '@/presentation/features/user-access/components/modals/AddRoleMemberModal'
import { INTERNAL_URLS, optimizeCloudinary } from '@/presentation/lib'
import {
...
import { TRole, TUser } from '@/presentation/types'
...
import { RemoveRoleMemberModal } from '../../../../../../features/user-access'
...
export default function RoleDetailPage({
    ...
    const confirmRemoveMemberModalState = useDisclosure({
        id: 'ConfirmRemoveMemberModal',
    })
    const handleOpenConfirmRemoveMemberModal = (user: TUser) => {
        setSelectedUser(user)
        confirmRemoveMemberModalState.onOpen()
    }
    const handleRemoveMember = async () => {
        ...
        removeMemberRole.mutateAsync(selectedUser.id, {
            onSuccess: () => {
                confirmRemoveMemberModalState.onClose()
            },
        })
    }
    ...
    return (
        <>
            {confirmRemoveMemberModalState.isOpen && selectedUser && (
                <RemoveRoleMemberModal
                    isOpen={confirmRemoveMemberModalState.isOpen}
                    onClose={confirmRemoveMemberModalState.onClose}
