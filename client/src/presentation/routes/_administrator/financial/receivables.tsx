import { RecordClientPaymentModal } from '@/presentation/features/financial'
import { receivableJobsOptions } from '@/presentation/lib/queries/options/_financial-queries'
