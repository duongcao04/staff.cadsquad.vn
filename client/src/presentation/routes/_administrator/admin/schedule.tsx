import JobScheduleModal from '@/presentation/features/schedules/components/modals/JobScheduleModal'
import ScheduleCalendarView, {
    CalendarSkeleton,
} from '@/presentation/features/schedules/components/views/ScheduleCalendarView'
import ScheduleListView from '@/presentation/features/schedules/components/views/ScheduleListView'
import { profileScheduleOptions, RouteUtil } from '@/presentation/lib'
import { AdminPageHeading } from '@presentation/components'
import { ErrorPageContent } from '@presentation/components/admin'
