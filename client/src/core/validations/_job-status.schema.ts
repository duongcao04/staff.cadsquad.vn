...
import { TJobStatus } from '../../presentation/types';
import { JobStatusSystemTypeEnum } from '../../presentation/enums';
import { COLORS, IMAGES } from '../utils';
import { JobSchema } from './_job.schema';

export const JobStatusSchema: ZodType<TJobStatus> = z.lazy(() => z.object({
  ...
  systemType: z.nativeEnum(JobStatusSystemTypeEnum)
  ...
  thumbnailUrl: z.string().default(IMAGES.cadsquadLogoOrange),
