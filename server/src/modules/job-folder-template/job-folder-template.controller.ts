...
export class JobFolderTemplateController {
	constructor(
		private readonly jobFolderTemplateService: JobFolderTemplateService
	) {}
	...
	async create(
		@Body() createJobFolderTemplateDto: CreateJobFolderTemplateDto
	) {
	...
	async update(
		...
		return this.jobFolderTemplateService.update(
			id,
			updateJobFolderTemplateDto
		)
	}
